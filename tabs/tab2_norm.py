...
def render(df_raw, val_col, p_value, is_normal, lambda_val, final_df, lsl, usl):
    ...
    if lambda_val is not None:
        ...
        fig_compare.add_trace(go.Histogram(x=final_df[val_col], name='변환', marker_color='steelblue', opacity=0.7), row=1, col=2)
